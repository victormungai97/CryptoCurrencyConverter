 ...
 * This fragment will inflate the layout for conversion between digital currencies
 */

public class DigitalCurrencyFragment extends GeneralCurrencyFragment {
    public static DigitalCurrencyFragment newInstance(String[] titles, String[] codes,
